<div class="main-home-wrap">
    ...
    <div class="quality-service-section">
        ...
        <div class="quality-service-section-text">
            <div class="quality-service-section-text-left">
                <img src="../assets/images/home-engine-part1.png" class="home-engine-part" alt="Workshop City Engine">
            </div>
    ...
    <img src="../assets/images/home-separador-img.png" class="cp-img" alt="Workshop City Comprehensive Services"
        width="100%" height="100%">
    <img src="../assets/images/R-separador.png" alt="Workshop City Comprehensive Services" width="100%" height="100%"
        class="mobile-img">
    ...
    <div class="qualified-experienced-section">
        <div class="qualif-exp-left">
            <img src="../assets/images/home-car-bonnet.png" class="home-car-img" alt="Workshop City Car Bonnet"
                width="100%" height="100%">
            <img src="../assets/images/home-mechanic.png" class="home-mechanic-img" alt="Workshop City Mechanic">
        </div>
